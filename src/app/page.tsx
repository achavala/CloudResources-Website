...
export default function Home() {
  return (
    <>
      ...
      {/* Stats Bar */}
      <section className="relative border-y border-white/5 bg-navy/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={item.step} className="relative group">
                <div className="text-6xl font-extrabold text-white/5 group-hover:text-cyan/10 transition-colors mb-4">
                  {item.step}
                </div>
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan/20 to-blue/20 flex items-center justify-center mb-4">
      ...
      <section className="relative py-24 sm:py-32 border-t border-white/5">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {caseStudies.map((study) => (
              <Link
                ...
                className="gradient-border p-8 hover-lift group block"
              >
                <span className="inline-block text-xs font-semibold text-cyan bg-cyan/10 px-3 py-1 rounded-full mb-5">
                  {study.tag}
                </span>
                <h3 className="text-xl font-bold text-text-primary mb-3 group-hover:text-cyan transition-colors">
                  {study.title}
                </h3>
          ...
          <div className="text-center mt-12">
            <Link
              href="/case-studies"
              className="group inline-flex items-center gap-2 text-cyan font-semibold hover:gap-3 transition-all"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="gradient-border p-8">
                <div className="text-3xl text-cyan/30 mb-4">&ldquo;</div>
                <p className="text-sm text-text-secondary leading-relaxed mb-6">
                  {t.quote}
                </p>
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            {clientImages.map((n) => (
              <div
                key={n}
                className="flex items-center justify-center py-4 px-4 rounded-xl border border-white/5 bg-white/[0.02] hover:border-cyan/20 transition-all"
              >
                <Image
                  ...
                  width={80}
                  height={40}
                  className="h-8 w-auto object-contain opacity-50 hover:opacity-80 transition-opacity brightness-0 invert"
                />
              </div>
            ))}
          </div>
      ...
      <section className="relative py-24 sm:py-32">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="gradient-border p-12 sm:p-16">
